...
- Uses a responsive aurora-terrain interface with a sticky top workspace navigator, click-to-Home product mark, focused sidebar filters, dimensional glass surfaces, and data-driven animated telemetry rails for readiness and KPI change—with accessible reduced-motion behavior.
